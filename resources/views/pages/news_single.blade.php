...
@section('content')
    {{-- breadcrumbs не правильно визначені тут --}}
            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries">
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-img">
                            <img src={{ asset('storage/assets/img/blog/blog-1.jpg') }} alt="" class="img-fluid">
                        </div>
                        ...
                        <div class="entry-content">
                            ...
                            <img src={{ asset('storage/assets/img/blog/blog-inside-post.jpg') }} class="img-fluid"
                                alt="">
