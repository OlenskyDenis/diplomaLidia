...
import sys
print(sys.argv[2])
df_pred = pd.read_csv('D:/Programs/OpenServer/domains/diplom/diplomaLidia/public/storage/assets/py/researches.csv')
...
feature_combination = [[20,20,7,3,2000,False]] #всі показники в нормі
Play_predicted= model.predict(feature_combination)

print ("Для наступної комбінації (ХСК,БСК5,pH,РК,ЛКП,аскариди)", feature_combination)
print ("Прогнозована якість води: ", Play_predicted)
#відсоток точності прогнозу
print('Точність прогнозу = ', accuracy_score(y_test,y_pred))
